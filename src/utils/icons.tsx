...
// Official Cursor AI 3D cube — multi-color, ignores color prop
export function CursorIcon({ size = 36 }: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 466.73 533.32" width={size} height={size}>
