...
export const theme = {
  colors: {
    ...
    badgeFrontend: "var(--color-badge-frontend)",
    badgeFullstack: "var(--color-badge-fullstack)",
    badgeVercel: "var(--color-badge-vercel)",
    badgeRender: "var(--color-badge-render)",
    badgeAws: "var(--color-badge-aws)",
    badgeNetlify: "var(--color-badge-netlify)",
    badgeCloudflare: "var(--color-badge-cloudflare)",
    badgeSdd: "var(--color-badge-sdd)",
  },
  fonts: {
